...
//This returns the total price + tax. If you just wanted the tax amount, times price by .07.
...
// CODE HERE
const totalPopulation = populations.reduce(function (runningTotal, currElement) {
	return runningTotal + currElement;
});
...
const orderTotals = orders.map(function (num) {
...
// CODE HERE
const bobsArray = purchases.filter(function (element) {
	return element.owner === "Bob";
});

// console.log(bobsArray);

const bobsTotal = bobsArray.reduce(function (grandTotal, current) {
	return grandTotal + current.price;
}, 0);
//Note: You needed to put current.price (it was console logging object object object object etc. Putting .price allowed you to access the price key within the bobsArray you created.)
...
//   return element.owner === "Bob"
// }).reduce(function(grandTotal, current){
//   return grandTotal + current.price
// }, 0)
